...
const Item = ({ product }) => {
  ...
  return (
        ...
        <div className='flex flex-col flex-nowrap p-1 items-center rounded-md bg-neutral-200 border-2 border-black hover:bg-cyan-200 duration-500'>
            <h3 className=' w-full text-center text-lg font-bold uppercase '>{ product.name }</h3>
            <img className='w-48 h-48 border-spacing-0 border-2 rounded-md border-gray-600 hover:scale-105 duration-500 ;' src= {product.img} alt="" />
