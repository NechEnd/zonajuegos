...
const NavBar = () => {
  return (
    <header className="w-full h-48 items-center flex flex-col brightness-95 bg-cover bg-center bg-no-repeat  bg-[url('https://wallpaperaccess.com/full/3143584.jpg')]">
